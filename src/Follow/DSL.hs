...
defining the DSL for concrete strategies.
...
Different strategies can define extra name/value pairs that will go in
new lines just after the base DSL. The definition is given as a
`Follow.Strategies.ArgumentsDSL` data type. See "Follow.Strategies"
for more details.
